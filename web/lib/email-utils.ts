...
const emailTemplates = {
  ...
  welcome: (name: string): EmailTemplate => ({
    ...
    text: `Hello ${name},\n\nWelcome to Synapse! We're excited to have you on board.\n\nGet started by exploring our features and connecting with other members.\n\nRegards,\nSynapse Team`,
    html: baseTemplate(`
      <h2 style="color: #333; margin-bottom: 20px;">Welcome to Synapse!</h2>
      <p>Hello ${name},</p>
  ...
  groupInvite: (
    ...
    subject: `You've been invited to join ${groupName} on Synapse`,
    text: `Hello ${name},\n\nYou've been invited to join ${groupName} on Synapse as a ${role} by ${sender.name}.\n\nClick the link below to accept the invitation:\n\n${inviteUrl}\n\nThe link will expire in 7 days.\n\nRegards,\nSynapse Team`,
    html: baseTemplate(`
      <div style="text-align: center; margin-bottom: 30px;">
        <h1 style="color: #333; margin: 0; font-size: 24px;">Synapse</h1>
      ...
      ">
        ...
        <p style="margin-bottom: 20px; color: #495057;">You've been invited to join <strong>${groupName}</strong> on Synapse. This group is a place to collaborate and share meals together.</p>
