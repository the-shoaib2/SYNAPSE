...
export const appConfig: AppConfig = {
  ...
  seo: {
    title: "Synapse - Meal Management System",
  ...
  branding: {
    logo: {
      icon: "🍽️",
      text: "Synapse",
      full: "Synapse - Meal Management System"
    },
    colors: {
      primary: "#3B82F6",
      secondary: "#64748B",
  ...
  about: {
    hero: {
      ...
      subtitle: "Synapse was born from a simple observation: shared living can be challenging, but it doesn't have to be. We're on a mission to make roommates' lives easier, one meal at a time.",
      ctaPrimary: {
    ...
    story: {
      ...
      content: [
        ...
        "We realized that shared living doesn't have to be complicated. With the right tools, roommates can not only survive together but thrive together. That's why we built Synapse - to transform the way people live together.",
  ...
  contact: {
    hero: {
      title: "Get in Touch",
      subtitle: "Have questions about Synapse? We'd love to hear from you. Send us a message and we'll respond as soon as possible."
    },
    info: {
      email: "contact@Synapse.com",
      phone: "+1 (555) 123-4567",
      ...
      sections: [
        {
          ...
          icon: "Shield",
          content: [
            "Welcome to Synapse (\"we,\" \"our,\" or \"us\"). These Terms of Service (\"Terms\") govern your use of our meal planning and shared living management platform, including our website, mobile applications, and related services (collectively, the \"Service\").",
        ...
        },
        {
          ...
          content: [
            "Synapse provides a platform for roommates and shared living communities to:",
            [
      ...
      sections: [
        {
          ...
          icon: "Shield",
          content: [
            "Synapse (\"we,\" \"our,\" or \"us\") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our meal planning and shared living management platform.",
