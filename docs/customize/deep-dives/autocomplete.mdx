---
title: "Autocomplete"
description: "Deep dive into Synapse's autocomplete functionality and configuration"
...
1. Make sure you have the "Enable Tab Autocomplete" setting checked (in VS Code, you can toggle by clicking the "Synapse" button in the status bar, and in JetBrains by going to Settings -> Tools -> Synapse).
...
Click the "Synapse" button in the status panel at the bottom right of the screen. The checkmark will become a "cancel" symbol and you will no longer see completions. You can click again to turn it back on.

Alternatively, open VS Code settings, search for "Synapse" and uncheck the box for "Enable Tab Autocomplete".
...
Open Settings -> Tools -> Synapse and uncheck the box for "Enable Tab Autocomplete".
