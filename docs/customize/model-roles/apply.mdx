...
You can customize the prompt template used for applying code changes by setting the `promptTemplates.apply` property in your model configuration. Synapse uses [Handlebars syntax](https://handlebarsjs.com/guide/) for templating.
