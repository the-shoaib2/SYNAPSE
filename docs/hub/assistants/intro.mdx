...
The `config.yaml` is parsed by the open-source Synapse IDE extensions to create custom assistant experiences. When you log in to [hub.synapse.dev](https://hub.synapse.dev/), your assistants will automatically be synced with the IDE extensions.
