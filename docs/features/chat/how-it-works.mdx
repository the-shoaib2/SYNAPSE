...
description: "Synapse's Chat feature provides a conversational interface with AI models directly in your IDE sidebar."
---

## Core Functionality

When you start a chat conversation, Synapse:
