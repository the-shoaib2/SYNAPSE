---
title: "Using Plan Mode with Synapse"
...
Context is the foundation of effective planning. Without proper context, AI models fall back on generic patterns, leading to plans that don't fit your specific system. Synapse's [context system](/features/chat/context-selection) transforms broad suggestions into actionable strategies:
...
<AccordionGroup>
  <Accordion title="Migrations & Upgrades">
    ...
    **Package Manager Migration**:
    `Create a plan to migrate from npm to npm, analyzing dependencies and potential breaking changes.`
