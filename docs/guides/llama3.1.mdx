---
title: "Using Llama 3.1 with Synapse"
description: "Synapse makes it easy to code with the latest open-source models, including the entire Llama 3.1 family of models. Llama 3.2 models are also supported but not recommended for chat, because they are specifically designed to be small or multi-modal."
---

If you haven't already installed Synapse, you can do that [here for VS Code](https://marketplace.visualstudio.com/items?itemName=Synapse.synapse) or [here for JetBrains](https://plugins.jetbrains.com/plugin/22707-synapse). For more general information on customizing Synapse, read [our customization docs](/customization/overview).
...
3. Change your Synapse config file like this:
...
2. Update your Synapse config file like this:
...
3. Update your Synapse config file like this:
...
2. Change your Synapse config file like this:
