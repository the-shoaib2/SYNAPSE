...
- [Using Ollama with Synapse](/guides/ollama-guide) - Local AI development with Ollama
...
- [Running Synapse Without Internet](/guides/running-synapse-without-internet) - Offline development setup
