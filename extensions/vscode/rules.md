The `extensions/vscode` folder contains code for the "Synapse" VS Code Extension. Synapse is a coding assistant extension which extends IDE functionality with AI.
