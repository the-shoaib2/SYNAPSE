...
export class SynapseUIWebviewViewProvider
  implements vscode.WebviewViewProvider
{
  public static readonly viewType = "synapse.synapseUIView";
  ...
  getSidebarContent(
    ...
    const vscMediaUrl: string = panel.webview
      .asWebviewUri(vscode.Uri.joinPath(extensionUri, "ui"))
      .toString();
    ...
    if (!inDevelopmentMode) {
      scriptUri = panel.webview
        .asWebviewUri(vscode.Uri.joinPath(extensionUri, "ui/assets/index.js"))
        .toString();
      styleMainUri = panel.webview
        .asWebviewUri(vscode.Uri.joinPath(extensionUri, "ui/assets/index.css"))
        .toString();
    } else {
    ...
    vscode.workspace.onDidChangeConfiguration((e) => {
      if (
        ...
        // Send new theme to UI to update embedded Monaco themes
